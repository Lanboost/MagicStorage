...
namespace MagicStorage
{
    public class UIButtonChoice : UIElement
    {
        ...
        {
            Texture2D backTexture = MagicStorage.Instance.GetTexture("SortButtonBackground").Value;
            Texture2D backTextureActive = MagicStorage.Instance.GetTexture("SortButtonBackgroundActive").Value;
